...
import com.hllbr.artbook_update_experiment_v2.databinding.ActivityDetailsBinding;
...
public class DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (info.equals("new")) {
            ...
            Bitmap selectImage = BitmapFactory.decodeResource(getApplicationContext().getResources(), R.drawable.taptoselect);
    ...
    public void selectImage(View view){
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED){
            if (ActivityCompat.shouldShowRequestPermissionRationale(this,Manifest.permission.READ_EXTERNAL_STORAGE)){
                Snackbar.make(view,"PERMİSSİON NEEDED FOR GALLERY",Snackbar.LENGTH_INDEFINITE).setAction("GİVE PERMİSSON", new View.OnClickListener() {
                            @Override
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK) {
                            Intent intentFromResult = result.getData();//getData = Intent
                            if (intentFromResult != null) {
                                Uri imageData = intentFromResult.getData();//getData = Uri
                                try {
    ...
    public void save(View view){
        ...
        Bitmap smallImage = maleSmallerImage(selectedImage,300);
    ...
    public Bitmap maleSmallerImage(Bitmap image,int maximumSize){
